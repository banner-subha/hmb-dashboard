...
const TONNES = new Set([
  ...
  'sp_target', 'potential', 'actual', 'bp_sp_target', 'bp_potential', 'actual_despatch',
  'total_sp_target', 'total_potential', 'total_co_target', 'cur_despatch_mt',
  'ig_sp_target', 'gg_sp_target', 'p_sp_target', 'rs_sp_target', 'ss_sp_target',
]);
const PERCENT = new Set([
  'pct_of_total', 'achievement_pct', 'match_pct', 'sp_target_pct', 'participation_pct',
]);
...
const HEADER = {
  ...
  avg_line_tonnes: 'Avg per Dispatch (MT)',
  ...
  year: 'Year',
  sp_target: 'Target (MT)',
  potential: 'Potential (MT)',
  actual: 'Actual (MT)',
  bp_sp_target: 'Target (MT)',
  bp_potential: 'Potential (MT)',
  actual_despatch: 'Actual (MT)',
  bp_dealers: 'Planned Dealers',
  active_dealers: 'Active Dealers',
  total_sp_target: 'SP Target (MT)',
  total_potential: 'Market Potential (MT)',
  total_co_target: 'CO Target (MT)',
  sp_target_pct: 'Target / Potential %',
  customer_count: 'Customers',
  submitted_count: 'Submitted',
  reviewed_count: 'Reviewed',
  pending_count: 'Pending Review',
  missing_count: 'Missing Plan',
  ig_sp_target: 'I Grill Target (MT)',
  gg_sp_target: 'Grill Guard Target (MT)',
  p_sp_target: 'Profile Target (MT)',
  rs_sp_target: 'Roofing Sheet Target (MT)',
  ss_sp_target: 'Stainless Steel Target (MT)',
  participation_pct: 'Participation',
  visit_count: 'Visits',
  cur_visits: 'Visits (Current)',
  hist_avg_monthly_visits: 'Hist. Avg Visits',
  visit_growth: 'Visit Growth',
  cur_despatch_mt: 'Despatch (MT)',
  unique_customers: 'Unique Customers',
  unique_employees: 'Active Reps',
  active_days: 'Active Days',
  avg_duration_mins: 'Avg Duration (mins)',
  visits_per_active_day: 'Visits / Day',
  dealer_visits: 'Dealer Visits',
  fabricator_visits: 'Fabricator Visits',
  morning_visits: 'Morning Visits',
  afternoon_visits: 'Afternoon Visits',
  evening_visits: 'Evening Visits',
  employee: 'Sales Rep',
  clean_size: 'Size / Dimension',
  item_category: 'Category',
  current_slab: 'Target Slab',
  kro: 'KRO',
  krm: 'KRM',
  jr_kro: 'Jr KRO',
