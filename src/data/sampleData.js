...
export const sampleData = {
  ...
  states: [
    { state: "WEST BENGAL",    cur: 541, prev: 688, mom: -21.4, share: 19, drop: 147, riskScore: 72, impactTier: "Critical", trendDirection: "down", trendLabel: "↓ 21.4%", displayColor: "#ef4444", operationalStatus: "Declining", products: [{ product: "IG", cur: 180, prev: 250, mom: -28 }, { product: "GI", cur: 200, prev: 210, mom: -4.8 }, { product: "HGI", cur: 80, prev: 120, mom: -33.3 }, { product: "SS", cur: 81, prev: 108, mom: -25 }] },
    { state: "BIHAR",          cur: 388, prev: 474, mom: -18.2, share: 14, drop: 86,  riskScore: 65, impactTier: "High",     trendDirection: "down", trendLabel: "↓ 18.2%", displayColor: "#f97316", operationalStatus: "Declining", products: [{ product: "IG", cur: 140, prev: 170, mom: -17.6 }, { product: "GI", cur: 120, prev: 130, mom: -7.7 }, { product: "HGI", cur: 68, prev: 94, mom: -27.7 }] },
    { state: "ODISHA",         cur: 271, prev: 307, mom: -11.7, share: 10, drop: 36,  riskScore: 48, impactTier: "Moderate", trendDirection: "down", trendLabel: "↓ 11.7%", displayColor: "#eab308", operationalStatus: "Declining", products: [{ product: "IG", cur: 90, prev: 100, mom: -10 }, { product: "GI", cur: 100, prev: 110, mom: -9.1 }] },
    { state: "JHARKHAND",      cur: 193, prev: 213, mom: -9.3,  share: 7,  drop: 20,  riskScore: 42, impactTier: "Moderate", trendDirection: "down", trendLabel: "↓ 9.3%",  displayColor: "#eab308", operationalStatus: "Declining", products: [{ product: "IG", cur: 70, prev: 80, mom: -12.5 }, { product: "P", cur: 60, prev: 55, mom: 9.1 }] },
    { state: "ASSAM",          cur: 147, prev: 157, mom: -6.1,  share: 5,  drop: 10,  riskScore: 28, impactTier: "Stable",   trendDirection: "down", trendLabel: "↓ 6.1%",  displayColor: "#22c55e", operationalStatus: "Stable",   products: [{ product: "GI", cur: 80, prev: 85, mom: -5.9 }] },
    { state: "UTTAR PRADESH",  cur: 420, prev: 380, mom: 10.5,  share: 15, drop: -40, riskScore: 12, impactTier: "Stable",   trendDirection: "up",   trendLabel: "↑ 10.5%", displayColor: "#22c55e", operationalStatus: "Growing",  products: [{ product: "GI", cur: 200, prev: 170, mom: 17.6 }, { product: "P", cur: 120, prev: 110, mom: 9.1 }] },
    { state: "CHHATTISGARH",   cur: 310, prev: 295, mom: 5.1,   share: 11, drop: -15, riskScore: 15, impactTier: "Stable",   trendDirection: "up",   trendLabel: "↑ 5.1%",  displayColor: "#22c55e", operationalStatus: "Growing",  products: [{ product: "IG", cur: 130, prev: 120, mom: 8.3 }] },
    { state: "MADHYA PRADESH", cur: 180, prev: 190, mom: -5.3,  share: 6,  drop: 10,  riskScore: 30, impactTier: "Low",      trendDirection: "down", trendLabel: "↓ 5.3%",  displayColor: "#10b981", operationalStatus: "Declining", products: [{ product: "SS", cur: 80, prev: 100, mom: -20 }] }
  ],
  districts: [
