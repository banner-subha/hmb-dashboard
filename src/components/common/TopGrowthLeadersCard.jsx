    ...
    >
      <div className="space-y-3.5 py-0.5">
        <div className="space-y-3">
          ...
          <div className="flex rounded-lg bg-bg-secondary p-1 border border-border/50">
            <button
              ...
              displayedList.map((item, idx) => {
                ...
                return (
                  <div 
                    ...
                    className="group flex items-center justify-between p-2.5 sm:p-3 rounded-lg bg-bg-secondary/60 hover:bg-bg-card border border-border/40 hover:border-accent-blue/40 transition-all cursor-pointer shadow-xs"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        {activeTab === 'districts' && item.state && (
                          <div className="text-xs text-text-muted flex items-center gap-1 font-medium mt-0.5">
        ...
        <div className="pt-2 border-t border-border/40">
          <button
            ...
            className="w-full py-2.5 px-4 rounded-lg bg-bg-secondary hover:bg-bg-card border border-border/60 hover:border-accent-blue/50 text-xs sm:text-sm font-bold text-accent-blue hover:text-accent-blue/80 flex items-center justify-center gap-2 transition-all cursor-pointer group shadow-xs"
          >
